...
def register():
    ...
    if test:
        return jsonify(message="That email is already in use")
    else:
...
def recover_password(email: str):
    ...
    if user:
        msg = Message('Your planetary API password is ' + user.password, sender="admin@acme.com", recipients=[email])
        mail.send(msg)
...
class PlanetSchema(ma.Schema):
    class Meta:
        fields = ('id', 'name', 'ptype', 'home_star', 'mass', 'radius', 'distance')
